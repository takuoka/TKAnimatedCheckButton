#
#  Be sure to run `pod spec lint TKAnimatedCheckButton.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/entotsu/TKAnimatedCheckButton"
  ...
  s.source       = { :git => "https://github.com/entotsu/TKAnimatedCheckButton.git", :tag => "0.3" }
  ...
  s.source_files  = "Classes", "TKAnimatedCheckButton/Classes/*.swift"
